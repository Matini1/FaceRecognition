...
st.markdown("<h6 style = 'top_margin: 0rem; color: #F2921D'>Built by Matini The Data Guy</h6>", unsafe_allow_html = True)

# Add an image to the page
st.image('png1.jpg', caption = 'FACE DETECTOR', width = 400)
